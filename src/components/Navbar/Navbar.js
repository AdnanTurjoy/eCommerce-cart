      ...
      <div class="justify-end w-full block flex-grow lg:flex lg:items-center  lg:w-auto">
        ...
        {user && (
          ...
          <span className="absolute right-0 top-0 rounded-full bg-red-600 w-4 h-4 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">
            ...
            <Link
              className="ml-3 inline-block text-sm px-4 py-2 mr-3 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0"
